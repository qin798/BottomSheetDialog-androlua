...
_M.setItems = function(items,icons,click)
  icons = icons or {}
  click = click or lambda():nil
  _M.setView(Layout.load(require("mods.dialog.bottomsheetdialog.dialog_list"),views))
  local adapter = LuaAdapter(activity,require("mods.dialog.bottomsheetdialog.dialog_listitem"))
...
return function(...)
  ...
  .setContentView(Layout.load(require("mods.dialog.bottomsheetdialog.dialog_bottomsheet"),views));
